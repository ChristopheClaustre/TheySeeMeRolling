...
int main(int argc, char *argv[])
{
    ...
    fp=fopen("../misc/WAVE/Sound.wav","rb");                                            //Open the WAVE file
    ...
    fread(&size, sizeof(int),1,fp);                                           //Continue to read the file
    ...
    cout << fread(buf,sizeof(int),dataSize,fp) << " bytes loaded\n";           //Read the sound data and display the
